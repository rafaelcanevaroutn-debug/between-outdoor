...
test('bloquea familias ajenas aunque se intente llamar a la API directamente', () => {
  for (const formatoCarrusel of ['editorial', 'itinerario', 'ascenso', 'lugar']) {
  ...
  for (const videoSubfamilia of ['1a', '2c', '3e', '5']) {
