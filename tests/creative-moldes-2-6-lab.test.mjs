...
import {MOLDE_2_CREATIVE_CONTRACT, MOLDE_2_MOCK_TEXT} from '../lib/creative-lab/molde-2-lab.ts'
import {MOLDE_6_CREATIVE_CONTRACT, MOLDE_6_MOCK_TEXT} from '../lib/creative-lab/molde-6-lab.ts'
