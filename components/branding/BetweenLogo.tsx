    ...
    >
      <span
        ...
        style={{
          ...
          marginRight: isWordmark ? '0.11em' : 0,
          background: 'linear-gradient(168deg, #3E5C48 0 68%, #2E4A38 68% 100%)',
          backgroundClip: 'text',
      ...
      {isWordmark && <span aria-hidden="true" style={{ color: 'var(--tinta)' }}>etween</span>}
    </span>
  )
}
