          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <p className="text-[15px] font-semibold" style={{ color: '#EAF2EC' }}>{calendar.nombre}</p>
                <p className="text-[12.5px] mt-1 leading-relaxed" style={{ color: '#9DB0A4' }}>{calendar.fraseCliente}</p>
              </div>
              <div
            ...
            <p className="text-[12px] mt-3 leading-relaxed" style={{ color: '#718479' }}>
              ...
              <div className="flex flex-wrap justify-end gap-1">
                {formatsForCalendar(calendar.code).map(format => (
                  <span
                    ...
                    style={{ color: '#82958A', backgroundColor: 'rgba(255,255,255,0.04)' }}
                  >
