...
const SCREEN_TITLES: Record<string, { eyebrow: string; title: string; subtitle: string }> = {
  ...
  '/fotos': { eyebrow: 'FOTOGRAFÍA', title: 'Tu biblioteca visual.', subtitle: 'Organizá el material por destino y escena. Between se ocupa del resto.' },
  '/videos': { eyebrow: 'VIDEOS', title: 'Escenas de tus viajes.', subtitle: 'Subí todo junto u organizalo por destino, momento o experiencia.' },
