  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      >
        ...
        >
          <Library className="w-6 h-6" style={{ color: '#5CE6A0' }} />
        </div>
        ...
        <p className="text-[13px] mb-6 max-w-sm" style={{ color: '#7E9286' }}>
          Acá vas a ver todo el material que subiste agrupado por slot. Por ahora subí el material desde el detalle de cada salida.
        </p>
        <Link
          href="/salidas"
