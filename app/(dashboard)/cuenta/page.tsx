...
export default async function CuentaPage() {
  ...
  const rows = [
    { label: 'Nombre', value: p.full_name || 'â€”', icon: User },
    { label: 'Empresa', value: p.company_name || 'â€”', icon: Building2 },
    { label: 'Nicho', value: (p.niche || 'â€”').replace(/_/g, ' '), icon: Tag },
  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      <div>
        ...
        <p className="text-[13px] mt-0.5" style={{ color: 'var(--piedra)' }}>Perfil y configuraciÃ³n del negocio</p>
      </div>
      ...
      >
        <div>
          ...
          <p className="text-[12px]" style={{ color: 'var(--piedra)' }}>USD 49 / mes Â· Acceso completo</p>
        </div>
        <span
