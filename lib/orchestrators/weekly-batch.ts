...
const generatedOutcomes = await generateSlotPieces(
        {
          ...
          formatoTexts: {
            ...
            carruselInternacionalText: loadKnowledge('formatos/carrusel_internacional.md'),
            videoInternacionalText: loadKnowledge('formatos/video_internacional.md'),
            bannerInternacionalText: loadKnowledge('formatos/banner_internacional.md'),
          },
          editorialBatchIndex,
