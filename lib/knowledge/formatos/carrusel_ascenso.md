# FORMATO: CARRUSEL ASCENSO (storytelling de salida real)
...
SLIDES DE HISTORIA (uno por momento del viaje)
- SIN pill_text.
- Una sola frase corta por foto, en PASADO, primera persona plural.
...
- Frase emocional de cierre + la venta:
  Ej: "¿Listo para este desafío? Próxima temporada 2026/27, preventa abierta"
- Fechas de las próximas salidas + CTA canónico.

## La descripción del post
- 2-3 líneas del viaje en tono nostálgico + fechas próximas + "comentá [PALABRA] y te enviamos la info".
...
- Cierre: foto de grupo/cumbre, la más celebratoria.

## Voz
- Pasado, primera persona plural ("cruzamos", "llegamos"). Es memoria, no folleto. Prohibido presente promocional en los slides de historia.
