...
export const MOLDE_4_CREATIVE_CONTRACT: CreativeTemplateContract = {
  template_id: 'banner_molde_4_calendario', version: '1.0.0', piece_type: 'banner', mold_type: 4,
...
export const MOLDE_4_CREATIVE_BRIEF = 'Banner de agenda con dos a cuatro próximas salidas verificadas. Debe leerse como cartelera editorial de viajes, no como tabla o dashboard. Cada destino y fecha es una unidad escaneable.'
export const MOLDE_4_CREATIVE_RUBRIC = 'Evaluar lectura rápida, jerarquía común, funcionamiento con dos y cuatro filas y ausencia de confusión entre destino y fecha.'
export const MOLDE_4_MOCK_TEXT = {marca: 'CAMINANTES VIAJES', titulo: 'PRÓXIMAS SALIDAS', salida_1_lugar: 'EL CHALTÉN', salida_1_fecha: '15 DE NOVIEMBRE', salida_2_lugar: 'TILCARA', salida_2_fecha: '6 DE DICIEMBRE', salida_3_lugar: 'BARILOCHE', salida_3_fecha: '17 DE ENERO', salida_4_lugar: 'USHUAIA', salida_4_fecha: '8 DE FEBRERO', cta: 'ELEGÍ TU PRÓXIMO VIAJE'} as const
export const MOLDE_4_CREATIVE_SKELETON = `<style data-template-css>.slide{position:relative;width:1080px;height:1350px;overflow:hidden;box-sizing:border-box;color:var(--brand-text);background:var(--brand-bg);border-color:var(--brand-primary);outline-color:var(--brand-secondary);font-family:var(--font-body)}h1,.place{font-family:var(--font-title)}</style><main class="slide"><img data-slot="bg_image" alt=""><header><img data-slot="logo" alt=""><p data-slot="marca"></p></header><h1 data-slot="titulo"></h1><section><article><p class="place" data-slot="salida_1_lugar"></p><p data-slot="salida_1_fecha"></p></article><article><p class="place" data-slot="salida_2_lugar"></p><p data-slot="salida_2_fecha"></p></article><article><p class="place" data-slot="salida_3_lugar"></p><p data-slot="salida_3_fecha"></p></article><article><p class="place" data-slot="salida_4_lugar"></p><p data-slot="salida_4_fecha"></p></article></section><p data-slot="cta"></p></main>`
