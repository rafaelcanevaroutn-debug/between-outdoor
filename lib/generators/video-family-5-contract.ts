...
function hasVerifiedCommercialDatum(salida: Salida): boolean {
  const hasPrice = salida.precio_usd !== null && Number.isFinite(salida.precio_usd) && salida.precio_usd > 0
  const hasCapacity = salida.cupos !== null && Number.isInteger(salida.cupos) && salida.cupos > 0
