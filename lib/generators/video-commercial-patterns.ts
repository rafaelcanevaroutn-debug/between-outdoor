...
export const CONCRETE_CTA_PATTERN = bounded(
  String.raw`whatsapp|link (?:de la|en) bio|por mp|mensaje privado|escribinos?|escribime|mandanos?|mandame|enviáselo|compartilo|sumate|coment(?:á|a|ar)|reserv(?:á|a|ar)|respond(?:é|e|er)`,
)
